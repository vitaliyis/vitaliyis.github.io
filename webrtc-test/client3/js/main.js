...
let config = {
    uri: '3002@fusionpbx.comapptech.net',
    transportOptions: {
    ...
    contact_uri: "3002@fusionpbx.comapptech.net",
    authorizationUser: '3002',
    registrarServer: "3002@fusionpbx.comapptech.net",
    userAgentString: "3002@fusionpbx.comapptech.net",
    displayName: "3002",
    password: 'BA!B.4JGE.',
    register: true,
    usePreloadedRoute: true,
