...
let config = {
    uri: '3001@fusionpbx.comapptech.net',
    transportOptions: {
    ...
    contact_uri: "3001@fusionpbx.comapptech.net",
    authorizationUser: '3001',
    registrarServer: "3001@fusionpbx.comapptech.net",
    userAgentString: "3001@fusionpbx.comapptech.net",
    displayName: "3001",
    password: 'e!P9UqFE!C',
    register: true,
    usePreloadedRoute: true,
